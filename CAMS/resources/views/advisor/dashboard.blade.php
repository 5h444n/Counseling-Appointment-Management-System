                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500">
                                @if($app->documents->count() > 0)
                                    <a href="{{ asset('storage/' . $app->documents->first()->file_path) }}" target="_blank" class="inline-flex items-center text-orange-600 hover:text-orange-900 border border-orange-200 bg-orange-50 px-2 py-1 rounded-md transition-colors">
