...
<div x-data="calendarApp()" x-init="initCalendar()" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <button @click="openModal()" class="px-3 py-1.5 bg-slate-900 text-white text-xs font-semibold rounded hover:bg-orange-600 transition-colors">
            + Add Note
        </button>
    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showModal"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" @click="saveEvent()" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-slate-900 text-base font-medium text-white hover:bg-orange-600 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm transition-colors">
                        Save
                    </button>
